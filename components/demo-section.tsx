...
const COPY = {
  pl: {
    ...
    note: "Dwie autentyczne pary opinia → odpowiedź wygenerowane przez ReviewGuide (nazwa i adres restauracji ukryta).",
    place: "Restauracja",
  ...
  en: {
    ...
    note: "Two authentic review → response pairs generated by ReviewGuide (restaurant name and address hidden).",
    place: "Restaurant",
